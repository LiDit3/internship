...
## Цель
Освоить базовое администрирование Linux: создание пользователей, безопасную настройку SSH/SFTP, интеграцию с Windows-инструментами для разработки и администрирования.
...
## Чек-лист выполнения
- [x] Создан отдельный пользователь (`intern`)
