...
## Чек-лист выполнения
- [ ] Включены компоненты Windows: `WSL` и `Virtual Machine Platform`
- [ ] Установлен и запущен WSL2 (по умолчанию версия 2)
- [ ] Установлен дистрибутив Debian (из Microsoft Store или `wsl --install`)
- [ ] Выполнено обновление пакетов: `apt update && apt upgrade -y`
- [ ] Установлены: `gcc`, `make`, `python3`, `python3-pip`, `mc`
- [ ] Запущен `mc`, проверена навигация и выход (`F10`)
- [ ] Изучена структура `/mnt/` (смонтированные диски Windows)
- [ ] Проверена совместимость и версии установленного ПО
