...
## Цель
Освоить работу с Windows Subsystem for Linux (WSL2), развернуть консольное окружение Debian, настроить репозитории, установить компиляторы и интерпретаторы, изучить интеграцию файловых систем Windows и Linux через точку монтирования `/mnt/`. 

## Стек и инструменты
- **Хост:** Windows 10/11
- **Подсистема:** `WSL2` (ядро Linux, полная совместимость системных вызовов)
- **Дистрибутив:** `Debian` — консольный/минимальный режим
